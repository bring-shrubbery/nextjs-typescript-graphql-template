...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/git/external?repository-url=https://github.com/bring-shrubbery/TypeScript-and-GraphQL-Example&project-name=with-typescript-graphql&repository-name=with-typescript-graphql)
...
```bash
npx create-next-app --example https://github.com/bring-shrubbery/TypeScript-and-GraphQL-Example with-typescript-graphql-app
# or
yarn create next-app --example https://github.com/bring-shrubbery/TypeScript-and-GraphQL-Example with-typescript-graphql-app
```
